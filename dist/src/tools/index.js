...
const activate_skill_1 = require("./activate-skill");
function createToolRegistry(skillManager) {
    // 在这里实例化所有的工具类
    const registeredTools = [
        ...
        ...(skillManager ? [new activate_skill_1.ActivateSkillTool(skillManager)] : []),
    ];
    // 组装传给大模型的 tools 定义
    const definitions = registeredTools.map(t => t.definition);
...
exports.definitions = defaultRegistry.definitions;
exports.implementations = defaultRegistry.implementations;
